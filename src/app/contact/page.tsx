...
export default function ContactPage() {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    // Server-side logic is disabled for static export.
    // In a real application with a server, you would handle form submission here.
    console.log('Form submission is disabled for static sites.', values);
